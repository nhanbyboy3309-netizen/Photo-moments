...
import { Printer, FileText, Trash2, ChevronRight, Loader2, Plus, Minus, Layers, CheckCircle, CreditCard, RefreshCw, Settings2, FileStack, CreditCard as IdCardIcon, Copy, Zap, Activity, Cpu } from 'lucide-react';
              ...
              <div className="space-y-6">
                  {files.length > 0 && (
                      <div className="bg-zinc-900 border border-zinc-800 rounded-[2rem] p-8 shadow-2xl space-y-6 sticky top-24">
                          <h3 className="font-bold text-white text-xl flex items-center gap-2 border-b border-zinc-800 pb-5"><Layers className="w-6 h-6 text-blue-500"/> Xác nhận đơn</h3>
