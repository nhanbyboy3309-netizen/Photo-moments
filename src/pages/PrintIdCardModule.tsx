...
import { X, Printer, Scissors, ArrowRight, Loader2, Image as ImageIcon, CheckCircle, Sliders, Plus, Minus } from 'lucide-react';
  ...
  useEffect(() => {
      ...
      const interval = setInterval(async () => {
          ...
          if (order && order.status === 'paid') {
              setWaitingForAdmin(false); setStep('print');
