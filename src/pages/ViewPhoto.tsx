...
import { getPhotoById, updatePhotoStatus, getSettings, verifyPartnerCode, redeemPartnerCode, confirmPhotoPayment } from '../services/mockBackend';
...
const ViewPhoto: React.FC = () => {
  ...
  const handleManualConfirmation = async () => {
    ...
    try {
        await updatePhotoStatus(photo.id, 'pending', email);
        await confirmPhotoPayment(photo.id, FINAL_AMOUNT, email);
