...
import { ShoppingCart, Search, Plus, Minus, Trash2, CreditCard, RotateCcw, User, Loader2, CheckCircle, X, Banknote, Wallet, Camera, ScanLine, ChevronUp, ChevronDown, Printer, ArrowRight } from 'lucide-react';
